...
PROTOBUF_CONSTEXPR Student::Student(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.marks_)*/{}
  , /*decltype(_impl_._marks_cached_byte_size_)*/{0}
  , /*decltype(_impl_.name_)*/nullptr
  , /*decltype(_impl_.average_mark_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
PROTOBUF_CONSTEXPR StudentsGroup::StudentsGroup(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.student_group_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
static ::_pb::Metadata file_level_metadata_StudentsGroup_2eproto[3];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_StudentsGroup_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_StudentsGroup_2eproto = nullptr;
...
const uint32_t TableStruct_StudentsGroup_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Students::FullName, _impl_.middle_name_),
  ~0u,
  ~0u,
  0,
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Students::Student, _impl_.marks_),
  PROTOBUF_FIELD_OFFSET(::Students::Student, _impl_.average_mark_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Students::StudentsGroup, _impl_.student_group_),
};
...
const char descriptor_table_protodef_StudentsGroup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023StudentsGroup.proto\022\010Students\"S\n\010FullN"
  "ame\022\014\n\004name\030\001 \001(\t\022\017\n\007surname\030\002 \001(\t\022\030\n\013mi"
  "ddle_name\030\003 \001(\tH\000\210\001\001B\016\n\014_middle_name\"P\n\007"
  "Student\022 \n\004name\030\001 \001(\0132\022.Students.FullNam"
  "e\022\r\n\005marks\030\002 \003(\005\022\024\n\014average_mark\030\003 \001(\001\"9"
  "\n\rStudentsGroup\022(\n\rstudent_group\030\001 \003(\0132\021"
  ".Students.Studentb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_StudentsGroup_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_StudentsGroup_2eproto = {
    false, false, 265, descriptor_table_protodef_StudentsGroup_2eproto,
    "StudentsGroup.proto",
    ...
    file_level_metadata_StudentsGroup_2eproto, file_level_enum_descriptors_StudentsGroup_2eproto,
    file_level_service_descriptors_StudentsGroup_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_StudentsGroup_2eproto_getter() {
  return &descriptor_table_StudentsGroup_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_StudentsGroup_2eproto(&descriptor_table_StudentsGroup_2eproto);
namespace Students {
...
class FullName::_Internal {
 public:
  ...
  static void set_has_middle_name(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
...
FullName::FullName(const FullName& from)
  ...
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_middle_name()) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Students.FullName.middle_name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* FullName::_InternalSerialize(
  ...
  if (_internal_has_middle_name()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "Students.FullName.middle_name");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_middle_name(), target);
  }
...
Student::Student(const Student& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.marks_){from._impl_.marks_}
    , /*decltype(_impl_._marks_cached_byte_size_)*/{0}
    , decltype(_impl_.name_){nullptr}
    , decltype(_impl_.average_mark_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  _this->_impl_.average_mark_ = from._impl_.average_mark_;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 25)) {
          _impl_.average_mark_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Student::_InternalSerialize(
  ...
  // repeated int32 marks = 2;
  {
    int byte_size = _impl_._marks_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
  ...
  if (raw_average_mark != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(3, this->_internal_average_mark(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Students.Student)
  ...
  // repeated int32 marks = 2;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->_impl_.marks_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._marks_cached_byte_size_.store(cached_size,
...
void Student::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.marks_.MergeFrom(from._impl_.marks_);
  if (from._internal_has_name()) {
  ...
  memcpy(&raw_average_mark, &tmp_average_mark, sizeof(tmp_average_mark));
  if (raw_average_mark != 0) {
    _this->_internal_set_average_mark(from._internal_average_mark());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void Student::InternalSwap(Student* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.marks_.InternalSwap(&other->_impl_.marks_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Student, _impl_.average_mark_)
      + sizeof(Student::_impl_.average_mark_)
...
StudentsGroup::StudentsGroup(const StudentsGroup& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.student_group_){from._impl_.student_group_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void StudentsGroup::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.student_group_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void StudentsGroup::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.student_group_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_student_group(), ptr);
            CHK_(ptr);
...
uint8_t* StudentsGroup::_InternalSerialize(
  ...
  // repeated .Students.Student student_group = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_student_group_size()); i < n; i++) {
    const auto& repfield = this->_internal_student_group(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:Students.StudentsGroup)
  ...
  // repeated .Students.Student student_group = 1;
  total_size += 1UL * this->_internal_student_group_size();
  for (const auto& msg : this->_impl_.student_group_) {
    total_size +=
...
void StudentsGroup::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.student_group_.MergeFrom(from._impl_.student_group_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void StudentsGroup::InternalSwap(StudentsGroup* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.student_group_.InternalSwap(&other->_impl_.student_group_);
}
